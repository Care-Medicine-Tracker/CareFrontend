  ...
  render()
  {
    return (
      <div>
        ...
        <ul>
          <li>Manage the <Link to={ApplicationPaths.MedicineInventoryPath}>Medicine Inventory</Link></li>
          <li>Check a user's <Link to={ApplicationPaths.UserMedicineInventoryPath}>User Medicine Inventory</Link></li>
        </ul>
        <p>You can also</p>
        <ul>
